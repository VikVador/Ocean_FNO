...
#SBATCH --output=__P4__FFNO_FULL_EDDIES_ONLINE.log                     # Log-file (important!)
...
# ---------------------
#
python -u online.py --folder_online EDDIES_ONLINE --folder_models __P4__FFNO_FULL --memory 40 --type_sim EDDIES
