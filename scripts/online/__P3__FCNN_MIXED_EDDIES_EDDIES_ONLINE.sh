...
#SBATCH --output=__P3__FCNN_MIXED_EDDIES_EDDIES_ONLINE.log                     # Log-file (important!)
...
# ---------------------
#
python -u online.py --folder_online EDDIES_ONLINE --folder_models __P3__FCNN_MIXED_EDDIES --memory 40 --type_sim EDDIES
