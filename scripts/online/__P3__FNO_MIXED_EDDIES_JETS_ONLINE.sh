...
#SBATCH --output=__P3__FNO_MIXED_EDDIES_JETS_ONLINE.log                     # Log-file (important!)
...
# ---------------------
#
python -u online.py --folder_online JETS_ONLINE --folder_models __P3__FNO_MIXED_EDDIES --memory 40 --type_sim JETS
