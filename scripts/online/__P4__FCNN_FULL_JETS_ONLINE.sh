...
#SBATCH --output=__P4__FCNN_FULL_JETS_ONLINE.log                     # Log-file (important!)
...
# ---------------------
#
python -u online.py --folder_online JETS_ONLINE --folder_models __P4__FCNN_FULL --memory 40 --type_sim JETS
