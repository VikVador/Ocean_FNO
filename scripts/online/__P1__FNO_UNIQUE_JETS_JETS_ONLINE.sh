...
#SBATCH --output=__P1__FNO_UNIQUE_JETS_JETS_ONLINE.log                     # Log-file (important!)
...
# ---------------------
#
python -u online.py --folder_online JETS_ONLINE --folder_models __P1__FNO_UNIQUE_JETS --memory 40 --type_sim JETS
