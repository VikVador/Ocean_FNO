...
#SBATCH --output=__P2__FCNN_MIXED_JETS_EDDIES_ONLINE.log                     # Log-file (important!)
...
# ---------------------
#
python -u online.py --folder_online EDDIES_ONLINE --folder_models __P2__FCNN_MIXED_JETS --memory 40 --type_sim EDDIES
