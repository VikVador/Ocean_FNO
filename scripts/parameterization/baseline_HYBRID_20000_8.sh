...
#    Slurm arguments
# ---------------------
#SBATCH --job-name=baseline_HYBRID_20000_8        # Name of the job
#SBATCH --export=ALL                           # Export all environment variables
#SBATCH --output=baseline_HYBRID_20000_8.log      # Log-file (important!)
