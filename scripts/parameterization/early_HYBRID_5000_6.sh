...
#    Slurm arguments
# ---------------------
#SBATCH --job-name=early_HYBRID_5000_6        # Name of the job
#SBATCH --export=ALL                           # Export all environment variables
#SBATCH --output=early_HYBRID_5000_6.log      # Log-file (important!)
...
# ---------------------
#
python -u train_parameterization.py --inputs q u --targets q_forcing_total --param_type HYBRID --param_name HYBRID_Early --sim_type hybrid/early --folder_training eddies_training_1 eddies_training_2 eddies_training_3 eddies_training_4 eddies_training_5 --num_epochs $numepoch --memory $memcpu --zero_mean True --padding circular --folder_validation eddies_validation_1 eddies_validation_2 eddies_validation_3 eddies_validation_4 eddies_validation_5 eddies_validation_6 eddies_validation_7 eddies_validation_8 eddies_validation_9 eddies_validation_10