...
#    Slurm arguments
# ---------------------
#SBATCH --job-name=baseline_HYBRID_20000_1        # Name of the job
#SBATCH --export=ALL                           # Export all environment variables
#SBATCH --output=baseline_HYBRID_20000_1.log      # Log-file (important!)
