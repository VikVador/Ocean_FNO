...
#    Slurm arguments
# ---------------------
#SBATCH --job-name=baseline_FCNN_5000_2        # Name of the job
#SBATCH --export=ALL                           # Export all environment variables
#SBATCH --output=baseline_FCNN_5000_2.log      # Log-file (important!)
