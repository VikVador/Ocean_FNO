...
#    Slurm arguments
# ---------------------
#SBATCH --job-name=baseline_FCNN_5000_7        # Name of the job
#SBATCH --export=ALL                           # Export all environment variables
#SBATCH --output=baseline_FCNN_5000_7.log      # Log-file (important!)
