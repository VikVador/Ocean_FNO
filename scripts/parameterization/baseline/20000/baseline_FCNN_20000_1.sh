...
#    Slurm arguments
# ---------------------
#SBATCH --job-name=baseline_FCNN_20000_1        # Name of the job
#SBATCH --export=ALL                           # Export all environment variables
#SBATCH --output=baseline_FCNN_20000_1.log      # Log-file (important!)
...
# ---------------------
# 5
python -u train_parameterization.py --inputs q --targets q_subgrid_forcing --folder_training eddies_training_1 eddies_training_2 eddies_training_3 eddies_training_4 eddies_training_5 eddies_training_6 eddies_training_7 eddies_training_8 eddies_training_9 eddies_training_10 eddies_training_11 eddies_training_12 eddies_training_13 eddies_training_14 eddies_training_15 eddies_training_16 eddies_training_17 eddies_training_18 eddies_training_19 eddies_training_20 --folder_validation eddies_validation_1 eddies_validation_2 eddies_validation_3 eddies_validation_4 eddies_validation_5 eddies_validation_6 eddies_validation_7 eddies_validation_8 eddies_validation_9 eddies_validation_10 --save_directory FCNN --num_epochs $numepoch --zero_mean True --padding circular --memory $memcpu --sim_type eddies/baseline