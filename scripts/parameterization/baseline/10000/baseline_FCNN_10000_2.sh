...
#    Slurm arguments
# ---------------------
#SBATCH --job-name=baseline_FCNN_10000_2        # Name of the job
#SBATCH --export=ALL                           # Export all environment variables
#SBATCH --output=baseline_FCNN_10000_2.log      # Log-file (important!)
...
# ---------------------
# 5
python -u train_parameterization.py --inputs q u --targets q_subgrid_forcing --folder_training eddies_training_1 eddies_training_2 eddies_training_3 eddies_training_4 eddies_training_5 eddies_training_6 eddies_training_7 eddies_training_8 eddies_training_9 eddies_training_10 --folder_validation eddies_validation_1 eddies_validation_2 eddies_validation_3 eddies_validation_4 eddies_validation_5 eddies_validation_6 eddies_validation_7 eddies_validation_8 eddies_validation_9 eddies_validation_10 --save_directory FCNN --num_epochs $numepoch --zero_mean True --padding circular --memory $memcpu --sim_type eddies/baseline