...
#SBATCH --output=__P4__FNO_FULL.log                         # Log-file (important!)
...
# ---------------------
#
python -u offline.py --folder_offline EDDIES_OFFLINE --folder_models __P4__FNO_FULL --memory 32 --type_sim EDDIES
