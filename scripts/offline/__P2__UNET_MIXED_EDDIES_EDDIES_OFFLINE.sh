...
#SBATCH --output=__P2__UNET_MIXED_EDDIES.log                         # Log-file (important!)
...
# ---------------------
#
python -u offline.py --folder_offline EDDIES_OFFLINE --folder_models __P2__UNET_MIXED_EDDIES --memory 32 --type_sim EDDIES
