...
#SBATCH --output=__P1__FFNO_UNIQUE_EDDIES.log                         # Log-file (important!)
...
# ---------------------
#
python -u offline.py --folder_offline EDDIES_OFFLINE --folder_models __P1__FFNO_UNIQUE_EDDIES --memory 32 --type_sim EDDIES
