...
#SBATCH --output=__P2__UNET_MIXED_JETS.log                         # Log-file (important!)
...
# ---------------------
#
python -u offline.py --folder_offline EDDIES_OFFLINE --folder_models __P2__UNET_MIXED_JETS --memory 32 --type_sim EDDIES
